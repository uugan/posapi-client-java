...
/**
 * GetApiReceiptReceiptGetProductTaxCodeResponseData
 */
public class GetApiReceiptReceiptGetProductTaxCodeResponseData {
    ...
    public GetApiReceiptReceiptGetProductTaxCodeResponseData() {
    }

    public GetApiReceiptReceiptGetProductTaxCodeResponseData startDate(@Nonnull String startDate) {
        this.startDate = startDate;
        return this;
    }

    /**
     * Дагаж мөрдөх дуусах огноо
     *
     * @return startDate
     */
    @Nonnull
    ...
    public GetApiReceiptReceiptGetProductTaxCodeResponseData endDate(@Nullable String endDate) {
        this.endDate = endDate;
        return this;
    }

    /**
     * Чөлөөлөгдөх бараа, ажил, үйлчилгээний код
     *
     * @return endDate
     */
    @Nullable
    ...
    public GetApiReceiptReceiptGetProductTaxCodeResponseData taxProductCode(@Nonnull String taxProductCode) {
    ...
    public void setTaxProductCode(@Nonnull String taxProductCode) {
        this.taxProductCode = taxProductCode;
    }


    public GetApiReceiptReceiptGetProductTaxCodeResponseData taxProductName(@Nonnull String taxProductName) {
        this.taxProductName = taxProductName;
        return this;
    }

    /**
     * Чөлөөлөгдөх бараа, ажил, үйлчилгээний нэр
     *
     * @return taxProductName
     */
    @Nonnull
    public String getTaxProductName() {
        return taxProductName;
    }

    public void setTaxProductName(@Nonnull String taxProductName) {
        this.taxProductName = taxProductName;
    }


    public GetApiReceiptReceiptGetProductTaxCodeResponseData taxTypeCode(@Nonnull BigDecimal taxTypeCode) {
        this.taxTypeCode = taxTypeCode;
        return this;
    }

    /**
     * Татвараас чөлөөлөгдөх төрөл
     *
     * @return taxTypeCode
     */
    @Nonnull
    ...
    public void setTaxTypeCode(@Nonnull BigDecimal taxTypeCode) {
        this.taxTypeCode = taxTypeCode;
    }


    public GetApiReceiptReceiptGetProductTaxCodeResponseData taxTypeName(@Nonnull String taxTypeName) {
        this.taxTypeName = taxTypeName;
        return this;
    }

    /**
     * Татвараас чөлөөлөгдөх төрлийн нэр
     *
     * @return taxTypeName
     */
    @Nonnull
    ...
    public void setTaxTypeName(@Nonnull String taxTypeName) {
        this.taxTypeName = taxTypeName;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetApiReceiptReceiptGetProductTaxCodeResponseData getApiReceiptReceiptGetProductTaxCodeResponseData = (GetApiReceiptReceiptGetProductTaxCodeResponseData) o;
        return Objects.equals(this.startDate, getApiReceiptReceiptGetProductTaxCodeResponseData.startDate) &&
                Objects.equals(this.endDate, getApiReceiptReceiptGetProductTaxCodeResponseData.endDate) &&
                Objects.equals(this.taxProductCode, getApiReceiptReceiptGetProductTaxCodeResponseData.taxProductCode) &&
                Objects.equals(this.taxProductName, getApiReceiptReceiptGetProductTaxCodeResponseData.taxProductName) &&
                Objects.equals(this.taxTypeCode, getApiReceiptReceiptGetProductTaxCodeResponseData.taxTypeCode) &&
                Objects.equals(this.taxTypeName, getApiReceiptReceiptGetProductTaxCodeResponseData.taxTypeName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(startDate, endDate, taxProductCode, taxProductName, taxTypeCode, taxTypeName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GetApiReceiptReceiptGetProductTaxCodeResponseData {\n");
        sb.append("    startDate: ").append(toIndentedString(startDate)).append("\n");
        sb.append("    endDate: ").append(toIndentedString(endDate)).append("\n");
        sb.append("    taxProductCode: ").append(toIndentedString(taxProductCode)).append("\n");
        sb.append("    taxProductName: ").append(toIndentedString(taxProductName)).append("\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("startDate", "endDate", "taxProductCode", "taxProductName", "taxTypeCode", "taxTypeName"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("startDate", "taxProductCode", "taxProductName", "taxTypeCode", "taxTypeName"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetApiReceiptReceiptGetProductTaxCodeResponseData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetApiReceiptReceiptGetProductTaxCodeResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetApiReceiptReceiptGetProductTaxCodeResponseData is not found in the empty JSON string", GetApiReceiptReceiptGetProductTaxCodeResponseData.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetApiReceiptReceiptGetProductTaxCodeResponseData.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetApiReceiptReceiptGetProductTaxCodeResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetApiReceiptReceiptGetProductTaxCodeResponseData.openapiRequiredFields) {
        ...
        if (!jsonObj.get("taxProductCode").isJsonPrimitive()) {
        ...
        if (!jsonObj.get("taxProductName").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `taxProductName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("taxProductName").toString()));
        }
        if (!jsonObj.get("taxTypeName").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `taxTypeName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("taxTypeName").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetApiReceiptReceiptGetProductTaxCodeResponseData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetApiReceiptReceiptGetProductTaxCodeResponseData' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetApiReceiptReceiptGetProductTaxCodeResponseData> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetApiReceiptReceiptGetProductTaxCodeResponseData.class));

            return (TypeAdapter<T>) new TypeAdapter<GetApiReceiptReceiptGetProductTaxCodeResponseData>() {
                @Override
                public void write(JsonWriter out, GetApiReceiptReceiptGetProductTaxCodeResponseData value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetApiReceiptReceiptGetProductTaxCodeResponseData read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetApiReceiptReceiptGetProductTaxCodeResponseData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetApiReceiptReceiptGetProductTaxCodeResponseData
     * @throws IOException if the JSON string is invalid with respect to GetApiReceiptReceiptGetProductTaxCodeResponseData
     */
    public static GetApiReceiptReceiptGetProductTaxCodeResponseData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetApiReceiptReceiptGetProductTaxCodeResponseData.class);
    }

    /**
     * Convert an instance of GetApiReceiptReceiptGetProductTaxCodeResponseData to an JSON string
     *
     * @return JSON string
     */
