 ...
 */
public class GetRestInfoResponseAppInfo {
@SerializedName("applicationDir")
  @Nonnull
...
@SerializedName("workDir")
  ...
  public GetRestInfoResponseAppInfo() {
  }

  public GetRestInfoResponseAppInfo applicationDir(@Nonnull String applicationDir) {
    this.applicationDir = applicationDir;
    return this;
  }

  /**
   * Файл байршиж буй хавтас
  ...
  public void setApplicationDir(@Nonnull String applicationDir) {
    this.applicationDir = applicationDir;
  }


  public GetRestInfoResponseAppInfo currentDir(@Nonnull String currentDir) {
  ...
  public void setCurrentDir(@Nonnull String currentDir) {
    this.currentDir = currentDir;
  }


  public GetRestInfoResponseAppInfo database(@Nonnull String database) {
    this.database = database;
    return this;
  }

  /**
   * Баазын driver /Qt5 тохиргоогоор/
   * @return database
   */
  @Nonnull
  ...
  public GetRestInfoResponseAppInfo databaseHost(@Nonnull String databaseHost) {
    this.databaseHost = databaseHost;
    return this;
  }

  /**
   * Баазын хаяг /sqlite бол файлын зам/
   * @return databaseHost
   */
  @Nonnull
  ...
  public void setDatabaseHost(@Nonnull String databaseHost) {
    this.databaseHost = databaseHost;
  }


  public GetRestInfoResponseAppInfo workDir(@Nonnull String workDir) {
  ...
  public boolean equals(Object o) {
    ...
    GetRestInfoResponseAppInfo getRestInfoResponseAppInfo = (GetRestInfoResponseAppInfo) o;
    return Objects.equals(this.applicationDir, getRestInfoResponseAppInfo.applicationDir) &&
        Objects.equals(this.currentDir, getRestInfoResponseAppInfo.currentDir) &&
        Objects.equals(this.database, getRestInfoResponseAppInfo.database) &&
        Objects.equals(this.databaseHost, getRestInfoResponseAppInfo.databaseHost) &&
        Objects.equals(this.workDir, getRestInfoResponseAppInfo.workDir);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationDir, currentDir, database, databaseHost, workDir);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetRestInfoResponseAppInfo {\n");
    sb.append("    applicationDir: ").append(toIndentedString(applicationDir)).append("\n");
    sb.append("    currentDir: ").append(toIndentedString(currentDir)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("applicationDir", "currentDir", "database", "database-host", "workDir"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("applicationDir", "currentDir", "database", "database-host", "workDir"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRestInfoResponseAppInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRestInfoResponseAppInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetRestInfoResponseAppInfo is not found in the empty JSON string", GetRestInfoResponseAppInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRestInfoResponseAppInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetRestInfoResponseAppInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRestInfoResponseAppInfo.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("applicationDir").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `applicationDir` to be a primitive type in the JSON string but got `%s`", jsonObj.get("applicationDir").toString()));
      }
      if (!jsonObj.get("currentDir").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `currentDir` to be a primitive type in the JSON string but got `%s`", jsonObj.get("currentDir").toString()));
      }
      ...
      if (!jsonObj.get("database-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `database-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("database-host").toString()));
      }
      if (!jsonObj.get("workDir").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `workDir` to be a primitive type in the JSON string but got `%s`", jsonObj.get("workDir").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRestInfoResponseAppInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRestInfoResponseAppInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRestInfoResponseAppInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRestInfoResponseAppInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRestInfoResponseAppInfo>() {
           @Override
           public void write(JsonWriter out, GetRestInfoResponseAppInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRestInfoResponseAppInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRestInfoResponseAppInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRestInfoResponseAppInfo
   * @throws IOException if the JSON string is invalid with respect to GetRestInfoResponseAppInfo
   */
  public static GetRestInfoResponseAppInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRestInfoResponseAppInfo.class);
  }

  /**
   * Convert an instance of GetRestInfoResponseAppInfo to an JSON string
   *
   * @return JSON string
   */
