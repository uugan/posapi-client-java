 ...
 * Эрэмбэлэлт
 */
public class GetApiInfoCheckBarcodeAllResponseSort {
    ...
    public GetApiInfoCheckBarcodeAllResponseSort() {
    }

    public GetApiInfoCheckBarcodeAllResponseSort sorted(@Nonnull Boolean sorted) {
        this.sorted = sorted;
        return this;
    }

    /**
     * Эрэмбэлэгдсэн эсэх (false &#x3D; Эрэмбэлэгдээгүй)
     *
     * @return sorted
     */
    @Nonnull
    ...
    public void setSorted(@Nonnull Boolean sorted) {
        this.sorted = sorted;
    }


    public GetApiInfoCheckBarcodeAllResponseSort unsorted(@Nonnull Boolean unsorted) {
        this.unsorted = unsorted;
        return this;
    }

    /**
     * Эрэмбэлэгдээгүй эсэх
     *
     * @return unsorted
     */
    @Nonnull
    ...
    public void setUnsorted(@Nonnull Boolean unsorted) {
        this.unsorted = unsorted;
    }


    public GetApiInfoCheckBarcodeAllResponseSort empty(@Nonnull Boolean empty) {
        this.empty = empty;
        return this;
    }

    /**
     * эрэмбэлэлтийн мэдээлэл хоосон эсэх
     *
     * @return empty
     */
    @Nonnull
    ...
    public boolean equals(Object o) {
        ...
        GetApiInfoCheckBarcodeAllResponseSort getApiInfoCheckBarcodeAllResponseSort = (GetApiInfoCheckBarcodeAllResponseSort) o;
        return Objects.equals(this.sorted, getApiInfoCheckBarcodeAllResponseSort.sorted) &&
                Objects.equals(this.unsorted, getApiInfoCheckBarcodeAllResponseSort.unsorted) &&
                Objects.equals(this.empty, getApiInfoCheckBarcodeAllResponseSort.empty);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetApiInfoCheckBarcodeAllResponseSort {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("sorted", "unsorted", "empty"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("sorted", "unsorted", "empty"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetApiInfoCheckBarcodeAllResponseSort
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetApiInfoCheckBarcodeAllResponseSort.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetApiInfoCheckBarcodeAllResponseSort is not found in the empty JSON string", GetApiInfoCheckBarcodeAllResponseSort.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetApiInfoCheckBarcodeAllResponseSort.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetApiInfoCheckBarcodeAllResponseSort` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetApiInfoCheckBarcodeAllResponseSort.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetApiInfoCheckBarcodeAllResponseSort.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetApiInfoCheckBarcodeAllResponseSort' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetApiInfoCheckBarcodeAllResponseSort> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetApiInfoCheckBarcodeAllResponseSort.class));

            return (TypeAdapter<T>) new TypeAdapter<GetApiInfoCheckBarcodeAllResponseSort>() {
                @Override
                public void write(JsonWriter out, GetApiInfoCheckBarcodeAllResponseSort value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetApiInfoCheckBarcodeAllResponseSort read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetApiInfoCheckBarcodeAllResponseSort given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetApiInfoCheckBarcodeAllResponseSort
     * @throws IOException if the JSON string is invalid with respect to GetApiInfoCheckBarcodeAllResponseSort
     */
    public static GetApiInfoCheckBarcodeAllResponseSort fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetApiInfoCheckBarcodeAllResponseSort.class);
    }

    /**
     * Convert an instance of GetApiInfoCheckBarcodeAllResponseSort to an JSON string
     *
     * @return JSON string
     */
