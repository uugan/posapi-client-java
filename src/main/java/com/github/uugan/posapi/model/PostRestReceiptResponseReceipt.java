...
/**
 * PostRestReceiptResponseReceipt
 */
public class PostRestReceiptResponseReceipt {
    @SerializedName("id")
    @Nonnull
    private String id;
    ...
    public PostRestReceiptResponseReceipt() {
    }

    public PostRestReceiptResponseReceipt id(@Nonnull String id) {
        this.id = id;
        return this;
    }
    ...
    public PostRestReceiptResponseReceipt bankAccountId(@Nonnull BigDecimal bankAccountId) {
        this.bankAccountId = bankAccountId;
        return this;
    }

    /**
     * ААН, Иргэний системд бүртгэсэн банкны дансны ID
     *
    ...
    public void setBankAccountId(@Nonnull BigDecimal bankAccountId) {
        this.bankAccountId = bankAccountId;
    }
    ...
    public boolean equals(Object o) {
        ...
        PostRestReceiptResponseReceipt postRestReceiptResponseReceipt = (PostRestReceiptResponseReceipt) o;
        return Objects.equals(this.id, postRestReceiptResponseReceipt.id) &&
                Objects.equals(this.bankAccountId, postRestReceiptResponseReceipt.bankAccountId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, bankAccountId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PostRestReceiptResponseReceipt {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("id", "bankAccountId"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "bankAccountId"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostRestReceiptResponseReceipt
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PostRestReceiptResponseReceipt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostRestReceiptResponseReceipt is not found in the empty JSON string", PostRestReceiptResponseReceipt.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PostRestReceiptResponseReceipt.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostRestReceiptResponseReceipt` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : PostRestReceiptResponseReceipt.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostRestReceiptResponseReceipt.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostRestReceiptResponseReceipt' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PostRestReceiptResponseReceipt> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(PostRestReceiptResponseReceipt.class));

            return (TypeAdapter<T>) new TypeAdapter<PostRestReceiptResponseReceipt>() {
                @Override
                public void write(JsonWriter out, PostRestReceiptResponseReceipt value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public PostRestReceiptResponseReceipt read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of PostRestReceiptResponseReceipt given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostRestReceiptResponseReceipt
     * @throws IOException if the JSON string is invalid with respect to PostRestReceiptResponseReceipt
     */
    public static PostRestReceiptResponseReceipt fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostRestReceiptResponseReceipt.class);
    }

    /**
     * Convert an instance of PostRestReceiptResponseReceipt to an JSON string
     *
     * @return JSON string
     */
