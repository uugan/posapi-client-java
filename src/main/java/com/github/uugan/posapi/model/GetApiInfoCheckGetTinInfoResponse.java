...
/**
 * GetApiInfoCheckGetTinInfoResponse
 */
public class GetApiInfoCheckGetTinInfoResponse {
    ...
    public GetApiInfoCheckGetTinInfoResponse() {
    }

    public GetApiInfoCheckGetTinInfoResponse status(@Nonnull BigDecimal status) {
        this.status = status;
        return this;
    }
    ...
    public GetApiInfoCheckGetTinInfoResponse msg(@Nullable String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public GetApiInfoCheckGetTinInfoResponse data(@Nullable BigDecimal data) {
        this.data = data;
        return this;
    }
    ...
    public void setData(@Nullable BigDecimal data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetApiInfoCheckGetTinInfoResponse getApiInfoCheckGetTinInfoResponse = (GetApiInfoCheckGetTinInfoResponse) o;
        return Objects.equals(this.status, getApiInfoCheckGetTinInfoResponse.status) &&
                Objects.equals(this.msg, getApiInfoCheckGetTinInfoResponse.msg) &&
                Objects.equals(this.data, getApiInfoCheckGetTinInfoResponse.data);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetApiInfoCheckGetTinInfoResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetApiInfoCheckGetTinInfoResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetApiInfoCheckGetTinInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetApiInfoCheckGetTinInfoResponse is not found in the empty JSON string", GetApiInfoCheckGetTinInfoResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetApiInfoCheckGetTinInfoResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetApiInfoCheckGetTinInfoResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetApiInfoCheckGetTinInfoResponse.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetApiInfoCheckGetTinInfoResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetApiInfoCheckGetTinInfoResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetApiInfoCheckGetTinInfoResponse> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetApiInfoCheckGetTinInfoResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<GetApiInfoCheckGetTinInfoResponse>() {
                @Override
                public void write(JsonWriter out, GetApiInfoCheckGetTinInfoResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetApiInfoCheckGetTinInfoResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetApiInfoCheckGetTinInfoResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetApiInfoCheckGetTinInfoResponse
     * @throws IOException if the JSON string is invalid with respect to GetApiInfoCheckGetTinInfoResponse
     */
    public static GetApiInfoCheckGetTinInfoResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetApiInfoCheckGetTinInfoResponse.class);
    }

    /**
     * Convert an instance of GetApiInfoCheckGetTinInfoResponse to an JSON string
     *
     * @return JSON string
     */
