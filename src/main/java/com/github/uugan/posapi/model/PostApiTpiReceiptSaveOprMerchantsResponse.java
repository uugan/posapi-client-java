...
/**
 * PostApiTpiReceiptSaveOprMerchantsResponse
 */
public class PostApiTpiReceiptSaveOprMerchantsResponse {
    @SerializedName("msg")
    @Nonnull
    private String msg;
    ...
    public PostApiTpiReceiptSaveOprMerchantsResponse() {
    }

    public PostApiTpiReceiptSaveOprMerchantsResponse msg(@Nonnull String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public PostApiTpiReceiptSaveOprMerchantsResponse status(@Nonnull BigDecimal status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        PostApiTpiReceiptSaveOprMerchantsResponse postApiTpiReceiptSaveOprMerchantsResponse = (PostApiTpiReceiptSaveOprMerchantsResponse) o;
        return Objects.equals(this.msg, postApiTpiReceiptSaveOprMerchantsResponse.msg) &&
                Objects.equals(this.status, postApiTpiReceiptSaveOprMerchantsResponse.status);
    }
    ...
    public String toString() {
        ...
        sb.append("class PostApiTpiReceiptSaveOprMerchantsResponse {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("msg", "status"));
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostApiTpiReceiptSaveOprMerchantsResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PostApiTpiReceiptSaveOprMerchantsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostApiTpiReceiptSaveOprMerchantsResponse is not found in the empty JSON string", PostApiTpiReceiptSaveOprMerchantsResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PostApiTpiReceiptSaveOprMerchantsResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostApiTpiReceiptSaveOprMerchantsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : PostApiTpiReceiptSaveOprMerchantsResponse.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostApiTpiReceiptSaveOprMerchantsResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostApiTpiReceiptSaveOprMerchantsResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PostApiTpiReceiptSaveOprMerchantsResponse> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(PostApiTpiReceiptSaveOprMerchantsResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<PostApiTpiReceiptSaveOprMerchantsResponse>() {
                @Override
                public void write(JsonWriter out, PostApiTpiReceiptSaveOprMerchantsResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public PostApiTpiReceiptSaveOprMerchantsResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of PostApiTpiReceiptSaveOprMerchantsResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostApiTpiReceiptSaveOprMerchantsResponse
     * @throws IOException if the JSON string is invalid with respect to PostApiTpiReceiptSaveOprMerchantsResponse
     */
    public static PostApiTpiReceiptSaveOprMerchantsResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostApiTpiReceiptSaveOprMerchantsResponse.class);
    }

    /**
     * Convert an instance of PostApiTpiReceiptSaveOprMerchantsResponse to an JSON string
     *
     * @return JSON string
     */
