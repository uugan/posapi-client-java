...
/**
 * GetRestInfoResponseMerchantCustomer
 */
public class GetRestInfoResponseMerchantCustomer {
    @SerializedName("name")
    @Nonnull
    private String name;
    @SerializedName("tin")
    ...
    public GetRestInfoResponseMerchantCustomer() {
    }

    public GetRestInfoResponseMerchantCustomer name(@Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public GetRestInfoResponseMerchantCustomer tin(@Nonnull String tin) {
        this.tin = tin;
        return this;
    }
    ...
    public GetRestInfoResponseMerchantCustomer vatPayer(@Nonnull String vatPayer) {
        this.vatPayer = vatPayer;
        return this;
    }

    /**
     * НӨАТ суутган төлөгч мөн эсэх  true: НӨАТ суутган төлөгч мөн  false: НӨАТ суутган төлөгч биш
     *
     * @return vatPayer
     */
    @Nonnull
    ...
    public void setVatPayer(@Nonnull String vatPayer) {
        this.vatPayer = vatPayer;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetRestInfoResponseMerchantCustomer getRestInfoResponseMerchantCustomer = (GetRestInfoResponseMerchantCustomer) o;
        return Objects.equals(this.name, getRestInfoResponseMerchantCustomer.name) &&
                Objects.equals(this.tin, getRestInfoResponseMerchantCustomer.tin) &&
                Objects.equals(this.vatPayer, getRestInfoResponseMerchantCustomer.vatPayer);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, tin, vatPayer);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GetRestInfoResponseMerchantCustomer {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("name", "tin", "vatPayer"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "tin", "vatPayer"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetRestInfoResponseMerchantCustomer
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetRestInfoResponseMerchantCustomer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetRestInfoResponseMerchantCustomer is not found in the empty JSON string", GetRestInfoResponseMerchantCustomer.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetRestInfoResponseMerchantCustomer.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetRestInfoResponseMerchantCustomer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetRestInfoResponseMerchantCustomer.openapiRequiredFields) {
        ...
        if (!jsonObj.get("vatPayer").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `vatPayer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vatPayer").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRestInfoResponseMerchantCustomer.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRestInfoResponseMerchantCustomer' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetRestInfoResponseMerchantCustomer> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetRestInfoResponseMerchantCustomer.class));

            return (TypeAdapter<T>) new TypeAdapter<GetRestInfoResponseMerchantCustomer>() {
                @Override
                public void write(JsonWriter out, GetRestInfoResponseMerchantCustomer value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetRestInfoResponseMerchantCustomer read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetRestInfoResponseMerchantCustomer given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetRestInfoResponseMerchantCustomer
     * @throws IOException if the JSON string is invalid with respect to GetRestInfoResponseMerchantCustomer
     */
    public static GetRestInfoResponseMerchantCustomer fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetRestInfoResponseMerchantCustomer.class);
    }

    /**
     * Convert an instance of GetRestInfoResponseMerchantCustomer to an JSON string
     *
     * @return JSON string
     */
