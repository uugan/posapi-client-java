...
/**
 * PostRestReceiptRequestPayment
 */
public class PostRestReceiptRequestPayment {
    @SerializedName("code")
    @Nonnull
    private String code;
    ...
    @SerializedName("data")
    @Nonnull
    private PostRestReceiptRequestPaymentData data;

    public PostRestReceiptRequestPayment() {
    }

    public PostRestReceiptRequestPayment code(@Nonnull String code) {
        this.code = code;
        return this;
    }

    /**
     * Төлбөрийн хэлбэрийн код  | Утга         | Тайлбар        |  |--------------|----------------|  | CASH         | Бэлнээр        |  | PAYMENT_CARD | Төлбөрийн карт/ |
     *
     * @return code
     */
    @Nonnull
    ...
    public PostRestReceiptRequestPayment exchangeCode(@Nullable String exchangeCode) {
        this.exchangeCode = exchangeCode;
        return this;
    }

    /**
     * Төлбөр хийж гүйцэтгэх гуравдагч системийн код
     *
     * @return exchangeCode
     */
    @Nullable
    ...
    public PostRestReceiptRequestPayment paidAmount(@Nonnull BigDecimal paidAmount) {
    ...
    public void setPaidAmount(@Nonnull BigDecimal paidAmount) {
        this.paidAmount = paidAmount;
    }


    public PostRestReceiptRequestPayment data(@Nonnull PostRestReceiptRequestPaymentData data) {
        this.data = data;
        return this;
    }
     ...
     */
    @Nonnull
    public PostRestReceiptRequestPaymentData getData() {
        return data;
    }

    public void setData(@Nonnull PostRestReceiptRequestPaymentData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        PostRestReceiptRequestPayment postRestReceiptRequestPayment = (PostRestReceiptRequestPayment) o;
        return Objects.equals(this.code, postRestReceiptRequestPayment.code) &&
                Objects.equals(this.exchangeCode, postRestReceiptRequestPayment.exchangeCode) &&
                Objects.equals(this.status, postRestReceiptRequestPayment.status) &&
                Objects.equals(this.paidAmount, postRestReceiptRequestPayment.paidAmount) &&
                Objects.equals(this.data, postRestReceiptRequestPayment.data);
    }

    @Override
    public int hashCode() {
        return Objects.hash(code, exchangeCode, status, paidAmount, data);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PostRestReceiptRequestPayment {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("code", "exchangeCode", "status", "paidAmount", "data"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "status", "paidAmount", "data"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostRestReceiptRequestPayment
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PostRestReceiptRequestPayment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostRestReceiptRequestPayment is not found in the empty JSON string", PostRestReceiptRequestPayment.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PostRestReceiptRequestPayment.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostRestReceiptRequestPayment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : PostRestReceiptRequestPayment.openapiRequiredFields) {
        ...
        if ((jsonObj.get("exchangeCode") != null && !jsonObj.get("exchangeCode").isJsonNull()) && !jsonObj.get("exchangeCode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `exchangeCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("exchangeCode").toString()));
        }
        if (!jsonObj.get("status").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("status").toString()));
        }
        // validate the required field `data`
        PostRestReceiptRequestPaymentData.validateJsonElement(jsonObj.get("data"));
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostRestReceiptRequestPayment.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostRestReceiptRequestPayment' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PostRestReceiptRequestPayment> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(PostRestReceiptRequestPayment.class));

            return (TypeAdapter<T>) new TypeAdapter<PostRestReceiptRequestPayment>() {
                @Override
                public void write(JsonWriter out, PostRestReceiptRequestPayment value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public PostRestReceiptRequestPayment read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of PostRestReceiptRequestPayment given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostRestReceiptRequestPayment
     * @throws IOException if the JSON string is invalid with respect to PostRestReceiptRequestPayment
     */
    public static PostRestReceiptRequestPayment fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostRestReceiptRequestPayment.class);
    }

    /**
     * Convert an instance of PostRestReceiptRequestPayment to an JSON string
     *
     * @return JSON string
     */
