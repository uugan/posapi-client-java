...
/**
 * GetRestBankAccountsTinTINResponse
 */
public class GetRestBankAccountsTinTINResponse {
    @SerializedName("id")
    @Nonnull
    ...
    public GetRestBankAccountsTinTINResponse() {
    }

    public GetRestBankAccountsTinTINResponse id(@Nonnull BigDecimal id) {
        this.id = id;
        return this;
    }

    /**
     * Хувь хүн, хуулийн этгээдийн системд бүртгэсэн банкны дансны ID
     *
     * @return id
     */
    @Nonnull
    ...
    public void setId(@Nonnull BigDecimal id) {
        this.id = id;
    }


    public GetRestBankAccountsTinTINResponse tin(@Nonnull String tin) {
        this.tin = tin;
        return this;
    }

    /**
     * Данс эзэмшигч хувь хүн, хуулийн этгээдийн ТТД
     *
     * @return tin
     */
    @Nonnull
    ...
    public GetRestBankAccountsTinTINResponse bankAccountNo(@Nonnull String bankAccountNo) {
    ...
    public void setBankAccountNo(@Nonnull String bankAccountNo) {
        this.bankAccountNo = bankAccountNo;
    }


    public GetRestBankAccountsTinTINResponse bankAccountName(@Nonnull String bankAccountName) {
    ...
    public void setBankAccountName(@Nonnull String bankAccountName) {
        this.bankAccountName = bankAccountName;
    }


    public GetRestBankAccountsTinTINResponse bankId(@Nonnull BigDecimal bankId) {
        this.bankId = bankId;
        return this;
    }
    ...
    public void setBankId(@Nonnull BigDecimal bankId) {
        this.bankId = bankId;
    }


    public GetRestBankAccountsTinTINResponse iBan(@Nonnull String iBan) {
        this.iBan = iBan;
        return this;
    }

    /**
     * Олон улсын банкны дансны дугаарлалт
     *
     * @return iBan
     */
    @Nonnull
    ...
    public GetRestBankAccountsTinTINResponse bankName(@Nonnull String bankName) {
    ...
    public boolean equals(Object o) {
        ...
        GetRestBankAccountsTinTINResponse getRestBankAccountsTinTINResponse = (GetRestBankAccountsTinTINResponse) o;
        return Objects.equals(this.id, getRestBankAccountsTinTINResponse.id) &&
                Objects.equals(this.tin, getRestBankAccountsTinTINResponse.tin) &&
                Objects.equals(this.bankAccountNo, getRestBankAccountsTinTINResponse.bankAccountNo) &&
                Objects.equals(this.bankAccountName, getRestBankAccountsTinTINResponse.bankAccountName) &&
                Objects.equals(this.bankId, getRestBankAccountsTinTINResponse.bankId) &&
                Objects.equals(this.iBan, getRestBankAccountsTinTINResponse.iBan) &&
                Objects.equals(this.bankName, getRestBankAccountsTinTINResponse.bankName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, tin, bankAccountNo, bankAccountName, bankId, iBan, bankName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GetRestBankAccountsTinTINResponse {\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("id", "tin", "bankAccountNo", "bankAccountName", "bankId", "iBan", "bankName", "..."));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "tin", "bankAccountNo", "bankAccountName", "bankId", "iBan", "bankName"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetRestBankAccountsTinTINResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetRestBankAccountsTinTINResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetRestBankAccountsTinTINResponse is not found in the empty JSON string", GetRestBankAccountsTinTINResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetRestBankAccountsTinTINResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetRestBankAccountsTinTINResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetRestBankAccountsTinTINResponse.openapiRequiredFields) {
        ...
        if (!jsonObj.get("bankAccountNo").isJsonPrimitive()) {
        ...
        if (!jsonObj.get("bankAccountName").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bankAccountName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("bankAccountName").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRestBankAccountsTinTINResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRestBankAccountsTinTINResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetRestBankAccountsTinTINResponse> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetRestBankAccountsTinTINResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<GetRestBankAccountsTinTINResponse>() {
                @Override
                public void write(JsonWriter out, GetRestBankAccountsTinTINResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetRestBankAccountsTinTINResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetRestBankAccountsTinTINResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetRestBankAccountsTinTINResponse
     * @throws IOException if the JSON string is invalid with respect to GetRestBankAccountsTinTINResponse
     */
    public static GetRestBankAccountsTinTINResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetRestBankAccountsTinTINResponse.class);
    }

    /**
     * Convert an instance of GetRestBankAccountsTinTINResponse to an JSON string
     *
     * @return JSON string
     */
