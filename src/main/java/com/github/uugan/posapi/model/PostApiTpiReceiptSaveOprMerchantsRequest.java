...
/**
 * PostApiTpiReceiptSaveOprMerchantsRequest
 */
public class PostApiTpiReceiptSaveOprMerchantsRequest {
    @SerializedName("posNo")
    @Nonnull
    private String posNo;
    @SerializedName("merchantTins")
    @Nonnull
    private List<String> merchantTins = new ArrayList<>();

    public PostApiTpiReceiptSaveOprMerchantsRequest() {
    }

    public PostApiTpiReceiptSaveOprMerchantsRequest posNo(@Nonnull String posNo) {
        this.posNo = posNo;
        return this;
    }
    ...
    public PostApiTpiReceiptSaveOprMerchantsRequest merchantTins(@Nonnull List<String> merchantTins) {
        this.merchantTins = merchantTins;
        return this;
    }

    public PostApiTpiReceiptSaveOprMerchantsRequest addMerchantTinsItem(String merchantTinsItem) {
        if (this.merchantTins == null) {
            this.merchantTins = new ArrayList<>();
        }
        this.merchantTins.add(merchantTinsItem);
        return this;
    }

    /**
     * Бүртгэх мерчантын жагсаалт
     *
     * @return merchantTins
     */
    @Nonnull
    public List<String> getMerchantTins() {
        return merchantTins;
    }

    public void setMerchantTins(@Nonnull List<String> merchantTins) {
        this.merchantTins = merchantTins;
    }
    ...
    public boolean equals(Object o) {
        ...
        PostApiTpiReceiptSaveOprMerchantsRequest postApiTpiReceiptSaveOprMerchantsRequest = (PostApiTpiReceiptSaveOprMerchantsRequest) o;
        return Objects.equals(this.posNo, postApiTpiReceiptSaveOprMerchantsRequest.posNo) &&
                Objects.equals(this.merchantTins, postApiTpiReceiptSaveOprMerchantsRequest.merchantTins);
    }

    @Override
    public int hashCode() {
        return Objects.hash(posNo, merchantTins);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PostApiTpiReceiptSaveOprMerchantsRequest {\n");
        sb.append("    posNo: ").append(toIndentedString(posNo)).append("\n");
        sb.append("    merchantTins: ").append(toIndentedString(merchantTins)).append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("posNo", "merchantTins"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("posNo", "merchantTins"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostApiTpiReceiptSaveOprMerchantsRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PostApiTpiReceiptSaveOprMerchantsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostApiTpiReceiptSaveOprMerchantsRequest is not found in the empty JSON string", PostApiTpiReceiptSaveOprMerchantsRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PostApiTpiReceiptSaveOprMerchantsRequest.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostApiTpiReceiptSaveOprMerchantsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : PostApiTpiReceiptSaveOprMerchantsRequest.openapiRequiredFields) {
        ...
        if (jsonObj.get("merchantTins") == null) {
            throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
        } else if (!jsonObj.get("merchantTins").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `merchantTins` to be an array in the JSON string but got `%s`", jsonObj.get("merchantTins").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostApiTpiReceiptSaveOprMerchantsRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostApiTpiReceiptSaveOprMerchantsRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PostApiTpiReceiptSaveOprMerchantsRequest> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(PostApiTpiReceiptSaveOprMerchantsRequest.class));

            return (TypeAdapter<T>) new TypeAdapter<PostApiTpiReceiptSaveOprMerchantsRequest>() {
                @Override
                public void write(JsonWriter out, PostApiTpiReceiptSaveOprMerchantsRequest value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public PostApiTpiReceiptSaveOprMerchantsRequest read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of PostApiTpiReceiptSaveOprMerchantsRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostApiTpiReceiptSaveOprMerchantsRequest
     * @throws IOException if the JSON string is invalid with respect to PostApiTpiReceiptSaveOprMerchantsRequest
     */
    public static PostApiTpiReceiptSaveOprMerchantsRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostApiTpiReceiptSaveOprMerchantsRequest.class);
    }

    /**
     * Convert an instance of PostApiTpiReceiptSaveOprMerchantsRequest to an JSON string
     *
     * @return JSON string
     */
