...
/**
 * GetApiInfoCheckGetBranchInfoResponseData
 */
public class GetApiInfoCheckGetBranchInfoResponseData {
    ...
    public GetApiInfoCheckGetBranchInfoResponseData() {
    }

    public GetApiInfoCheckGetBranchInfoResponseData branchCode(@Nonnull String branchCode) {
    ...
    public GetApiInfoCheckGetBranchInfoResponseData branchName(@Nonnull String branchName) {
    ...
    public GetApiInfoCheckGetBranchInfoResponseData subBranchCode(@Nonnull String subBranchCode) {
    ...
    public void setSubBranchCode(@Nonnull String subBranchCode) {
        this.subBranchCode = subBranchCode;
    }


    public GetApiInfoCheckGetBranchInfoResponseData subBranchName(@Nonnull String subBranchName) {
    ...
    public void setSubBranchName(@Nonnull String subBranchName) {
        this.subBranchName = subBranchName;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetApiInfoCheckGetBranchInfoResponseData getApiInfoCheckGetBranchInfoResponseData = (GetApiInfoCheckGetBranchInfoResponseData) o;
        return Objects.equals(this.branchCode, getApiInfoCheckGetBranchInfoResponseData.branchCode) &&
                Objects.equals(this.branchName, getApiInfoCheckGetBranchInfoResponseData.branchName) &&
                Objects.equals(this.subBranchCode, getApiInfoCheckGetBranchInfoResponseData.subBranchCode) &&
                Objects.equals(this.subBranchName, getApiInfoCheckGetBranchInfoResponseData.subBranchName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(branchCode, branchName, subBranchCode, subBranchName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GetApiInfoCheckGetBranchInfoResponseData {\n");
        sb.append("    branchCode: ").append(toIndentedString(branchCode)).append("\n");
        sb.append("    branchName: ").append(toIndentedString(branchName)).append("\n");
        sb.append("    subBranchCode: ").append(toIndentedString(subBranchCode)).append("\n");
        sb.append("    subBranchName: ").append(toIndentedString(subBranchName)).append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("branchCode", "branchName", "subBranchCode", "subBranchName"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("branchCode", "branchName", "subBranchCode", "subBranchName"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetApiInfoCheckGetBranchInfoResponseData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetApiInfoCheckGetBranchInfoResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetApiInfoCheckGetBranchInfoResponseData is not found in the empty JSON string", GetApiInfoCheckGetBranchInfoResponseData.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetApiInfoCheckGetBranchInfoResponseData.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetApiInfoCheckGetBranchInfoResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetApiInfoCheckGetBranchInfoResponseData.openapiRequiredFields) {
        ...
        if (!jsonObj.get("branchCode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `branchCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("branchCode").toString()));
        }
        ...
        if (!jsonObj.get("subBranchCode").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `subBranchCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subBranchCode").toString()));
        }
        if (!jsonObj.get("subBranchName").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `subBranchName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subBranchName").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetApiInfoCheckGetBranchInfoResponseData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetApiInfoCheckGetBranchInfoResponseData' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetApiInfoCheckGetBranchInfoResponseData> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetApiInfoCheckGetBranchInfoResponseData.class));

            return (TypeAdapter<T>) new TypeAdapter<GetApiInfoCheckGetBranchInfoResponseData>() {
                @Override
                public void write(JsonWriter out, GetApiInfoCheckGetBranchInfoResponseData value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetApiInfoCheckGetBranchInfoResponseData read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetApiInfoCheckGetBranchInfoResponseData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetApiInfoCheckGetBranchInfoResponseData
     * @throws IOException if the JSON string is invalid with respect to GetApiInfoCheckGetBranchInfoResponseData
     */
    public static GetApiInfoCheckGetBranchInfoResponseData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetApiInfoCheckGetBranchInfoResponseData.class);
    }

    /**
     * Convert an instance of GetApiInfoCheckGetBranchInfoResponseData to an JSON string
     *
     * @return JSON string
     */
