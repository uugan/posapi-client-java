...
/**
 * GetApiInfoCheckGetInfoResponse
 */
public class GetApiInfoCheckGetInfoResponse {
    ...
    @SerializedName("data")
    @Nonnull
    private GetApiInfoCheckGetInfoResponseData data;

    public GetApiInfoCheckGetInfoResponse() {
    }

    public GetApiInfoCheckGetInfoResponse status(@Nonnull BigDecimal status) {
        this.status = status;
        return this;
    }
    ...
    public GetApiInfoCheckGetInfoResponse msg(@Nonnull String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public GetApiInfoCheckGetInfoResponse data(@Nonnull GetApiInfoCheckGetInfoResponseData data) {
        this.data = data;
        return this;
    }
     ...
     */
    @Nonnull
    public GetApiInfoCheckGetInfoResponseData getData() {
        return data;
    }

    public void setData(@Nonnull GetApiInfoCheckGetInfoResponseData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetApiInfoCheckGetInfoResponse getApiInfoCheckGetInfoResponse = (GetApiInfoCheckGetInfoResponse) o;
        return Objects.equals(this.status, getApiInfoCheckGetInfoResponse.status) &&
                Objects.equals(this.msg, getApiInfoCheckGetInfoResponse.msg) &&
                Objects.equals(this.data, getApiInfoCheckGetInfoResponse.data);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetApiInfoCheckGetInfoResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetApiInfoCheckGetInfoResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetApiInfoCheckGetInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetApiInfoCheckGetInfoResponse is not found in the empty JSON string", GetApiInfoCheckGetInfoResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetApiInfoCheckGetInfoResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetApiInfoCheckGetInfoResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : GetApiInfoCheckGetInfoResponse.openapiRequiredFields) {
        ...
        GetApiInfoCheckGetInfoResponseData.validateJsonElement(jsonObj.get("data"));
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetApiInfoCheckGetInfoResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetApiInfoCheckGetInfoResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetApiInfoCheckGetInfoResponse> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(GetApiInfoCheckGetInfoResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<GetApiInfoCheckGetInfoResponse>() {
                @Override
                public void write(JsonWriter out, GetApiInfoCheckGetInfoResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public GetApiInfoCheckGetInfoResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of GetApiInfoCheckGetInfoResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetApiInfoCheckGetInfoResponse
     * @throws IOException if the JSON string is invalid with respect to GetApiInfoCheckGetInfoResponse
     */
    public static GetApiInfoCheckGetInfoResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetApiInfoCheckGetInfoResponse.class);
    }

    /**
     * Convert an instance of GetApiInfoCheckGetInfoResponse to an JSON string
     *
     * @return JSON string
     */
