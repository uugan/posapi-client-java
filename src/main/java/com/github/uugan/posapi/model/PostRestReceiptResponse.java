...
/**
 * PostRestReceiptResponse
 */
public class PostRestReceiptResponse {
    @SerializedName("id")
    @Nonnull
    private String id;
    ...
    @Nonnull
    private List<PostRestReceiptResponseReceipt> receipts = new ArrayList<>();

    public PostRestReceiptResponse() {
    }

    public PostRestReceiptResponse id(@Nonnull String id) {
        this.id = id;
        return this;
    }
    ...
    public PostRestReceiptResponse posId(@Nonnull BigDecimal posId) {
        this.posId = posId;
        return this;
    }

    /**
     * PosAPI-н системийн дугаар
     *
     * @return posId
     */
    @Nonnull
    ...
    public PostRestReceiptResponse status(@Nonnull String status) {
        this.status = status;
        return this;
    }
    ...
    public PostRestReceiptResponse message(@Nonnull String message) {
    ...
    public PostRestReceiptResponse qrDate(@Nonnull String qrDate) {
        this.qrDate = qrDate;
        return this;
    }
    ...
    public void setQrDate(@Nonnull String qrDate) {
        this.qrDate = qrDate;
    }


    public PostRestReceiptResponse lottery(@Nonnull String lottery) {
    ...
    public void setLottery(@Nonnull String lottery) {
        this.lottery = lottery;
    }


    public PostRestReceiptResponse date(@Nonnull LocalDate date) {
        this.date = date;
        return this;
    }

    /**
     * Баримт хэвэлсэн огноо
     *
     * @return date
     */
    @Nonnull
    ...
    public PostRestReceiptResponse easy(@Nonnull String easy) {
        this.easy = easy;
        return this;
    }

    /**
     * Хялбар бүртгэл хийгдсэн эсэх  true - хялбар бүртгэлд бүртгэсэн  false - хялбар бүртгэлд бүртгээгүй
     *
     * @return easy
     */
    @Nonnull
    ...
    public void setEasy(@Nonnull String easy) {
        this.easy = easy;
    }


    public PostRestReceiptResponse receipts(@Nonnull List<PostRestReceiptResponseReceipt> receipts) {
        this.receipts = receipts;
        return this;
    }

    public PostRestReceiptResponse addReceiptsItem(PostRestReceiptResponseReceipt receiptsItem) {
     ...
     */
    @Nonnull
    public List<PostRestReceiptResponseReceipt> getReceipts() {
        return receipts;
    }

    public void setReceipts(@Nonnull List<PostRestReceiptResponseReceipt> receipts) {
        this.receipts = receipts;
    }
    ...
    public boolean equals(Object o) {
        ...
        PostRestReceiptResponse postRestReceiptResponse = (PostRestReceiptResponse) o;
        return Objects.equals(this.id, postRestReceiptResponse.id) &&
                Objects.equals(this.posId, postRestReceiptResponse.posId) &&
                Objects.equals(this.status, postRestReceiptResponse.status) &&
                Objects.equals(this.message, postRestReceiptResponse.message) &&
                Objects.equals(this.qrDate, postRestReceiptResponse.qrDate) &&
                Objects.equals(this.lottery, postRestReceiptResponse.lottery) &&
                Objects.equals(this.date, postRestReceiptResponse.date) &&
                Objects.equals(this.easy, postRestReceiptResponse.easy) &&
                Objects.equals(this.receipts, postRestReceiptResponse.receipts);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, posId, status, message, qrDate, lottery, date, easy, receipts);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PostRestReceiptResponse {\n");
        sb.append("    id: ").append(toIndentedString(id)).append("\n");
        sb.append("    posId: ").append(toIndentedString(posId)).append("\n");
        sb.append("    status: ").append(toIndentedString(status)).append("\n");
        sb.append("    message: ").append(toIndentedString(message)).append("\n");
        sb.append("    qrDate: ").append(toIndentedString(qrDate)).append("\n");
    ...
    static {
        ...
        openapiFields = new HashSet<String>(Arrays.asList("id", "posId", "status", "message", "qrDate", "lottery", "date", "easy", "receipts"));

        // a set of required properties/fields (JSON key names)
        openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "posId", "status", "message", "qrDate", "lottery", "date", "easy", "receipts"));
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostRestReceiptResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PostRestReceiptResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PostRestReceiptResponse is not found in the empty JSON string", PostRestReceiptResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!PostRestReceiptResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PostRestReceiptResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : PostRestReceiptResponse.openapiRequiredFields) {
        ...
        if (!jsonObj.get("qrDate").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `qrDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("qrDate").toString()));
        }
        if (!jsonObj.get("lottery").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `lottery` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lottery").toString()));
        }
        if (!jsonObj.get("easy").isJsonPrimitive()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `easy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("easy").toString()));
        }
        ...
        for (int i = 0; i < jsonArrayreceipts.size(); i++) {
            PostRestReceiptResponseReceipt.validateJsonElement(jsonArrayreceipts.get(i));
        }
        ;
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostRestReceiptResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostRestReceiptResponse' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PostRestReceiptResponse> thisAdapter
                    = gson.getDelegateAdapter(this, TypeToken.get(PostRestReceiptResponse.class));

            return (TypeAdapter<T>) new TypeAdapter<PostRestReceiptResponse>() {
                @Override
                public void write(JsonWriter out, PostRestReceiptResponse value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public PostRestReceiptResponse read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of PostRestReceiptResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostRestReceiptResponse
     * @throws IOException if the JSON string is invalid with respect to PostRestReceiptResponse
     */
    public static PostRestReceiptResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostRestReceiptResponse.class);
    }

    /**
     * Convert an instance of PostRestReceiptResponse to an JSON string
     *
     * @return JSON string
     */
