...
public class PosApiException extends Exception {
    ...
    /**
     * <p>Constructor for PosApiException.</p>
     */
     ...
     */
    public PosApiException(Throwable throwable) {
        super(throwable);
    }
     ...
     */
    public PosApiException(String message, Throwable throwable, int code, Map<String, List<String>> responseHeaders, String responseBody) {
     ...
     * @param responseBody the response body
     */
    public PosApiException(String message, int code, Map<String, List<String>> responseHeaders, String responseBody) {
     ...
     * @param responseHeaders a {@link java.util.Map} of HTTP response headers
     */
    public PosApiException(String message, Throwable throwable, int code, Map<String, List<String>> responseHeaders) {
     ...
     * @param responseBody the response body
     */
    public PosApiException(int code, Map<String, List<String>> responseHeaders, String responseBody) {
     ...
     * @param responseBody the response body
     */
    public PosApiException(int code, String message, Map<String, List<String>> responseHeaders, String responseBody) {
        this(code, message);
        this.responseHeaders = responseHeaders;
        this.responseBody = responseBody;
    }
