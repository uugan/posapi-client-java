...
import com.github.uugan.posapi.auth.Authentication;
import com.github.uugan.posapi.auth.HttpBasicAuth;
import com.github.uugan.posapi.auth.HttpBearerAuth;
import com.github.uugan.posapi.auth.ApiKeyAuth;

/**
 * <p>PosApiClient class.</p>
 */
public class PosApiClient {

    protected String basePath = "http://localhost:7080";
    ...
    /**
     * Basic constructor for PosApiClient
     */
    public PosApiClient() {
        init();
        initHttpClient();
        ...
        authentications.put("auth.yaml", new HttpBearerAuth("bearer"));
        authentications.put("auth_copy.yaml", new HttpBearerAuth("bearer"));
     ...
     */
    public PosApiClient(OkHttpClient client) {
        init();
     ...
     * @return An instance of PosApiClient
     */
    public PosApiClient setBasePath(String basePath) {
    ...
    public PosApiClient setServers(List<ServerConfiguration> servers) {
    ...
    public PosApiClient setServerIndex(Integer serverIndex) {
    ...
    public PosApiClient setServerVariables(Map<String, String> serverVariables) {
     ...
     */
    public PosApiClient setHttpClient(OkHttpClient newHttpClient) {
     ...
     * @return Api client
     */
    public PosApiClient setJSON(JSON json) {
        this.json = json;
        return this;
    }
     ...
     * @return PosApiClient
     */
    public PosApiClient setVerifyingSsl(boolean verifyingSsl) {
     ...
     * @return PosApiClient
     */
    public PosApiClient setSslCaCert(InputStream sslCaCert) {
     ...
     * @return PosApiClient
     */
    public PosApiClient setKeyManagers(KeyManager[] managers) {
     ...
     * @return PosApiClient
     */
    public PosApiClient setTlsServerName(String tlsServerName) {
     ...
     * @return a {@link PosApiClient} object
     */
    public PosApiClient setDateFormat(DateFormat dateFormat) {
     ...
     * @return a {@link PosApiClient} object
     */
    public PosApiClient setSqlDateFormat(DateFormat dateFormat) {
     ...
     * @return a {@link PosApiClient} object
     */
    public PosApiClient setOffsetDateTimeFormat(DateTimeFormatter dateFormat) {
     ...
     * @return a {@link PosApiClient} object
     */
    public PosApiClient setLocalDateFormat(DateTimeFormatter dateFormat) {
     ...
     * @return a {@link PosApiClient} object
     */
    public PosApiClient setLenientOnJson(boolean lenientOnJson) {
     ...
     * @return PosApiClient
     */
    public PosApiClient setUserAgent(String userAgent) {
     ...
     * @return PosApiClient
     */
    public PosApiClient addDefaultHeader(String key, String value) {
     ...
     * @return PosApiClient
     */
    public PosApiClient addDefaultCookie(String key, String value) {
     ...
     * @return PosApiClient
     */
    public PosApiClient setDebugging(boolean debugging) {
     ...
     * @return PosApiClient
     */
    public PosApiClient setTempFolderPath(String tempFolderPath) {
     ...
     * @return Api client
     */
    public PosApiClient setConnectTimeout(int connectionTimeout) {
     ...
     * @return Api client
     */
    public PosApiClient setReadTimeout(int readTimeout) {
     ...
     * @return Api client
     */
    public PosApiClient setWriteTimeout(int writeTimeout) {
    ...
    */
     ...
     * @throws PosApiException If fail to deserialize response body, i.e. cannot read response body
     *   or the Content-Type of the response is not supported.
     */
    @SuppressWarnings("unchecked")
    public <T> T deserialize(Response response, Type returnType) throws PosApiException {
     ...
     * @throws PosApiException If fail to serialize the given object
     */
    public RequestBody serialize(Object obj, String contentType) throws PosApiException {
        if (obj instanceof byte[]) {
            ...
            throw new PosApiException("Content type \"" + contentType + "\" is not supported");
        }
    }
     ...
     * @throws PosApiException If fail to read file content from response and write to disk
     * @return Downloaded file
     */
    public File downloadFileFromResponse(Response response) throws PosApiException {
        try {
     ...
     * @return PosApiResponse&lt;T&gt;
     * @throws PosApiException If fail to execute the call
     */
    public <T> PosApiResponse<T> execute(Call call) throws PosApiException {
     ...
     * @param call Call
     * @return PosApiResponse object containing response status, headers and
     *   data, which is a Java object deserialized from response body and would be null
     *   when returnType is null.
     * @throws PosApiException If fail to execute the call
     */
    public <T> PosApiResponse<T> execute(Call call, Type returnType) throws PosApiException {
        try {
            Response response = call.execute();
            T data = handleResponse(response, returnType);
            return new PosApiResponse<T>(response.code(), response.headers().toMultimap(), data);
        } catch (IOException e) {
            throw new PosApiException(e);
        }
    }
    ...
    /**
     * {@link #executeAsync(Call, Type, PosApiCallback)}
     *
     * @param <T> Type
     * @param call An instance of the Call object
     * @param callback PosApiCallback&lt;T&gt;
     */
    public <T> void executeAsync(Call call, PosApiCallback<T> callback) {
     ...
     * @param callback PosApiCallback
     * @see #execute(Call, Type)
     */
    @SuppressWarnings("unchecked")
    public <T> void executeAsync(Call call, final Type returnType, final PosApiCallback<T> callback) {
        call.enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                callback.onFailure(new PosApiException(e), 0, null);
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    callback.onFailure(new PosApiException(e), response.code(), response.headers().toMultimap());
                    return;
                }
     ...
     * @param returnType Return type
     * @return Type
     * @throws PosApiException If the response has an unsuccessful status code or
     *                      fail to deserialize the response body
     */
    public <T> T handleResponse(Response response, Type returnType) throws PosApiException {
        if (response.isSuccessful()) {
            if (returnType == null || response.code() == 204) {
                ...
                if (response.body() != null) {
                    try {
                        ...
                        throw new PosApiException(response.message(), e, response.code(), response.headers().toMultimap());
                    }
                }
                return null;
            } else {
            ...
            throw new PosApiException(response.message(), response.code(), response.headers().toMultimap(), respBody);
        }
    }
     ...
     */
    public Call buildCall(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, PosApiCallback callback) throws PosApiException {
     ...
     * @throws PosApiException If fail to serialize the request body object
     */
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, PosApiCallback callback) throws PosApiException {
     ...
     * @param uri URI
     * @throws PosApiException If fails to update the parameters
     */
    public void updateParamsForAuth(String[] authNames, List<Pair> queryParams, Map<String, String> headerParams,
                                    Map<String, String> cookieParams, String payload, String method, URI uri) throws PosApiException {
    ...
    protected Interceptor getProgressInterceptor() {
        return new Interceptor() {
            ...
            public Response intercept(Interceptor.Chain chain) throws IOException {
                ...
                if (request.tag() instanceof PosApiCallback) {
                    final PosApiCallback callback = (PosApiCallback) request.tag();
     ...
     * @throws PosApiException If fail to serialize the request body object into a string
     */
    protected String requestBodyToString(RequestBody requestBody) throws PosApiException {
        if (requestBody != null) {
            try {
