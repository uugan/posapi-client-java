...
public class PosApiResponse<T> {
    ...
    /**
     * <p>Constructor for PosApiResponse.</p>
     *
     * @param statusCode The status code of HTTP response
     * @param headers The headers of HTTP response
     */
    public PosApiResponse(int statusCode, Map<String, List<String>> headers) {
     ...
     */
    public PosApiResponse(int statusCode, Map<String, List<String>> headers, T data) {
