...
public class Configuration {
  ...
  private static final AtomicReference<PosApiClient> defaultApiClient = new AtomicReference<>();
  private static volatile Supplier<PosApiClient> apiClientFactory = PosApiClient::new;
   ...
   */
  public static PosApiClient getDefaultApiClient() {
    PosApiClient client = defaultApiClient.get();
    if (client == null) {
   ...
   *
   * @param posApiClient API client
   */
  public static void setDefaultApiClient(PosApiClient posApiClient) {
    defaultApiClient.set(posApiClient);
  }

  /**
   * set the callback used to create new PosApiClient objects
   */
  public static void setApiClientFactory(Supplier<PosApiClient> factory) {
